...
Func AtkLogHead()
	...
	SetAtkLog(GetTranslated(601, 16, "                   --------  LOOT --------       ----- BONUS ------"), "", $COLOR_GREEN)
	If $ichkSwitchAcc = 1 Then
		SetAtkLog("AC|" & GetTranslated(601, 17, " TIME|TROP.|SEARCH|   GOLD| ELIXIR|DARK EL|TR.|S|  GOLD|ELIXIR|  DE|L."), "", $COLOR_GREEN)
	Else
